...
class PointTest {
	...
	void testEqualsObject() {
		...
		Vector v45 = new Vector(4,5);
		assertNotEquals(p34,v45);
		assertNotEquals(p34,null);
		
		Point p35 = new Point(3,5);
		assertFalse(p34.equals(p35));
		
		//hashcode
		Point p34_2 = new Point(3,4);
		assertEquals(p34_2.hashCode(),p34.hashCode());		
	}
	...
	void testMinusPoint() {
		Vector v45 = new Vector(4,5);
		Vector vm28 = new Vector(-2,8);
		assertEquals(v45,p34.minus(new Point(-1,-1)));
		assertEquals(vm28,p34.minus(new Point(5,-4)));
	}
