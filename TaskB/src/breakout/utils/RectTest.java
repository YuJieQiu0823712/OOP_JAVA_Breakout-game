...
class RectTest {
	...
	@Test
	void testConstrainCircle() {
		assertEquals (c251,r1138.constrain(c251));
	}
	
	@Test
	void testHashCode() {
		Rect r1138_2 = new Rect(p11,p38);
		assertEquals (r1138.hashCode(),r1138_2.hashCode());
	}

	@Test
	void testEquals() {
		Vector v34 = new Vector(3,4);		
		assertEquals(r1138,r1138);
		assertNotEquals(r1138,null);
		assertNotEquals(r1138,v34);
		assertNotEquals(r1138,r1125);
		
		Rect r3838 = new Rect(p38,p38);
		assertNotEquals(r1138,r3838);

		Rect r1138_2 = new Rect(p11,p38);
		assertEquals(r1138,r1138_2);
	}
