...
class CircleTest {
	...
	void testEquals() {
		...
		assertEquals(c252,c252);
		assertNotEquals(c252,null);
		assertNotEquals(c252,v34);
		assertNotEquals(c252,c389);
		
		Circle circle = new Circle(new Point(6,6),2);
		assertNotEquals(c252,circle);
		
		Circle circle2 = new Circle(new Point(2,5),2);
		assertEquals(c252,circle2);
	}
}
